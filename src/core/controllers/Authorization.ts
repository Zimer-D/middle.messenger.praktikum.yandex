...
class AuthController {
    public signIn(data: ILoginData) {
      return Client
        ...
        .catch((e)=>alert('Что-то пошло не так, возможно неверный логин или пароль'));
    }
  
    public signUp(data: IRegistrationData) {
      return Client
        .post(`${URLS.API_URL}/auth/signup`, {
          data: JSON.stringify(data),
